...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .card { background:#fff; padding:24px; border-radius:12px; border-top:6px solid #2C6E49; box-shadow:0 6px 16px rgba(0,0,0,0.08); margin-bottom:18px; }
    .form-group { margin-bottom:14px; }
    label { display:block; margin-bottom:6px; color:#2D3A3A; font-weight:600; }
    input, select { width:100%; padding:10px; border:1.5px solid #A7D9C5; border-radius:7px; }
